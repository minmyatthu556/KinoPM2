...
public final class Uhrzeit implements Comparable<Uhrzeit>
{
    ...
    public static Uhrzeit get(int stunden, int minuten)
    {
        assert (stunden >= 0) && (stunden < 24)
            : "Vorbedingung verletzt: stunden >= 0 && stunden < 24";
        assert (minuten >= 0) && (minuten < 60)
            : "Vorbedingung verletzt: minuten >= 0 && minuten < 60";
    ...
    public int getStunden()
    {
        assert (_stunden >= 0)
                && (_stunden < 24)
            : "Nachbedingung verletzt: (result >= 0) && (result < 24)";
    ...
    {
        assert (_minuten >= 0) && (_minuten < 60)
            : "Nachbedingung verletzt: (result >= 0) && (result < 60)";
    ...
    public int minutenSeit(Uhrzeit startzeit)
    {
        ...
        int result = (u2._stunden - u1._stunden) * 60 + u2._minuten - u1._minuten;
